  ...
  return (
    <div>
      <Title className="mb-4">
        {selectedProduct ? selectedProduct?.title : "Yangi mahsulot qo'shish"}{" "}
      </Title>
      ...
      {selectedProduct ? (
        <BuyCreate product={selectedProduct} handleCancel={handleCancel} />
      ) : isCreate ? (
        <ProductCreate handleCancel={handleCancel} />
      ) : (
        <></>
      )}
    </div>
